...
function Ex_Clientes_Prospecto(props) {
  ...
  const handleChangeProspecto = (event) => {
    ...
    const handleGetCidades = () =>{
      axios.get(`${process.env.REACT_APP_BASE_URL}/clientes_inativos_prospecto/cidades`)
        .then(result => { 
    ...
    const handleGetDados = () =>{
        axios.post(`${process.env.REACT_APP_BASE_URL}/clientes_inativos_prospecto`,{city: cidade, fprospecto: prospecto})
          .then(result => { 
