...
function ChartTodasRenovacoes(props) {
    ...
    useEffect(()=> {
       setBackdrop(!backdrop)
       var result =[];
      axios.post(`${process.env.REACT_APP_BASE_URL}/upgrade/cidade`,{ data_inicial: dataInicial.split('T')[0], data_final: dataFinal.split('T')[0] })
        .then(upgrade => {      
           axios.post(`${process.env.REACT_APP_BASE_URL}/renovacoes/cidade`,{ data_inicial: dataInicial.split('T')[0], data_final: dataFinal.split('T')[0] })
           .then(renovacoes=>{
            axios.post(`${process.env.REACT_APP_BASE_URL}/migracoes/cidade`,{ data_inicial: dataInicial.split('T')[0], data_final: dataFinal.split('T')[0] })
            .then((migracoes)=>{
...
export default ChartTodasRenovacoes;