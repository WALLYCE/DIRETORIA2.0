...
useEffect(()=>{
    ...
    async function getDados(){
        const city= await axios.get(`${process.env.REACT_APP_BASE_URL}/cliente_servico/cidades`);
        city.data.unshift({cidade: 'Geral'});
        setCidades(city.data);
        const val = await  axios.get(`${process.env.REACT_APP_BASE_URL}/cliente_servico/contrato/tempo`);
        setDados(val.data);
        setBackdrop(false)
    }
                    ...
                    <FormControl fullWidth>
                        <InputLabel id="demo-simple-select-label">Cidade</InputLabel>
                                ...
                                >
                                    ...
                                    return( <MenuItem key={index} value={item.cidade}>{item.cidade}</MenuItem>)
                                    })}
